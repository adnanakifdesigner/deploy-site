  ...
  const ButtonContent = ({ variant }: { variant: 'primary' | 'secondary' }) => {
    ...
    return (
      <div className="flex items-center gap-1 flex-shrink-0">
        <span
          className={`text-[22px] font-normal tracking-wide uppercase rounded-full px-2 py-1 whitespace-nowrap h-[24px] flex items-center border ${
            isPrimary
...
export default function Header() {
  ...
  const navLinks = ['Work', 'Store', 'Contact']
